...
@section('content')
    <div class="card b-radius--10">
        <div class="card-body">
            <form class="dashboard-form" id="orderConfirmation" action="{{ route('user.order.create', @$service->id) }}" method="POST">
                @csrf
                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form--control" name="service_id" required> </select>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control form--control" name="quantity" type="number" value="{{ old('quantity') }}" required>
        ...
        var categoryHtml = `
            <div class="category-select">
                <div class="selected-category d-flex justify-content-between align-items-center">
                    <p class="category-title">Facebook Page Like <span span class="badge badge--primary"></span> (100)</p>
                    <div class="icon-area">
