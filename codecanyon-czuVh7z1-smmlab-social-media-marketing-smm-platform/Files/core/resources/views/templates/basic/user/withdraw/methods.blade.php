                            ...
                            <div class="mt-3 preview-details d-none">
                                <ul class="list-group text-center">
                                    <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <span><span class="min fw-bold">0</span> {{__(gs("cur_text"))}} - <span class="max fw-bold">0</span> {{__(gs("cur_text"))}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between">
                                        <span>@lang('Receivable')</span> <span><span class="receivable fw-bold"> 0</span> {{__(gs("cur_text"))}} </span>
                                    </li>
    ...
    (function ($) {
            ...
            $('select[name=method_code]').change(function(){
                ...
                if (resource.currency != '{{ gs("cur_text") }}') {
                    var rateElement = `<span>@lang('Conversion Rate')</span> <span class="fw-bold">1 {{__(gs("cur_text"))}} = <span class="rate">${rate}</span>  <span class="base-currency">${resource.currency}</span></span>`;
